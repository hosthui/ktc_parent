...
import com.ktc.article.service.ColumnService;
...
return  new Result(StatusCode.OK,true,"查询成功",  new PageResult<Column>((int)pageList.getTotalElements(), pageList.getContent()) );
}
