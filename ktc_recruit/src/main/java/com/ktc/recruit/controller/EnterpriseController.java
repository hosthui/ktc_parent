...
public class EnterpriseController {
	...
	public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
		...
		return new Result(StatusCode.OK, true, "查询成功", new PageResult<Enterprise>((int)pageList.getTotalElements(), pageList.getContent()));
	}
	...
	public Result hotlist(){
		return new Result(StatusCode.OK,true,"查询成功",enterpriseService.hotlist());
	}
}
