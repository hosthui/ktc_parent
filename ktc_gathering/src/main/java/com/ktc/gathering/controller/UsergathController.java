...
public class UsergathController {
	...
	public Result findAll() {
		return new Result(StatusCode.OK, true, "查询成功", usergathService.findAll());
	}
	...
	public Result findById(@PathVariable String id) {
		return new Result(StatusCode.OK, true, "查询成功", usergathService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
		...
		return new Result(StatusCode.OK, true, "查询成功", new PageResult<Usergath>((int)pageList.getTotalElements(), pageList.getContent()));
	}
	...
	public Result findSearch(@RequestBody Map searchMap) {
		return new Result(StatusCode.OK, true, "查询成功", usergathService.findSearch(searchMap));
	}
