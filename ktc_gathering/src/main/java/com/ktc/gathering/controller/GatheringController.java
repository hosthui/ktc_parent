...
import com.ktc.gathering.service.GatheringService;
...
public class GatheringController {
	...
	public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
		...
		return new Result(StatusCode.OK, true, "查询成功", new PageResult<Gathering>((int)pageList.getTotalElements(), pageList.getContent()));
	}
